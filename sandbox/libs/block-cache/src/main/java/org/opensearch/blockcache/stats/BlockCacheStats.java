 ...
 * particularly relevant for variable-size entries (e.g. Parquet column chunks)
 * where byte-level hit rate is more meaningful than count-based hit rate.
 *
...
public final class BlockCacheStats implements IBlockCacheStats, Writeable, ToXContentFragment {
     ...
     *
     * @param raw          buffer returned by {@link org.opensearch.blockcache.foyer.FoyerBridge#snapshotStats}
